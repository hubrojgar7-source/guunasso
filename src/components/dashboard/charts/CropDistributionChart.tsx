...
const budgetData = [
  ...
  { name: 'Social Security', value: 15.4, amount: 135000, color: '#EC4899' },
  { name: 'Debt Repayment', value: 8.9, amount: 78000, color: '#14B8A6' },
    ...
    <Card className="bg-white border border-gray-200/50 rounded-2xl overflow-hidden shadow-sm h-full flex flex-col">
      <CardHeader className="pb-2 px-4 pt-4">
        <div className="flex items-center justify-between flex-wrap gap-2">
          <CardTitle className="text-lg font-semibold text-zinc-900">Budget Categories</CardTitle>
          <div className="text-xs text-muted-foreground bg-muted px-3 py-1 rounded-md">
            Total: Rs. {(totalBudget / 1000).toFixed(1)}B
          </div>
        </div>
      </CardHeader>
